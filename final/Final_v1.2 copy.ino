...
// EC and pH calibration removed: use direct converted sensor values.
...
// Generate sensor reading JSON string
...
void setup() {
  ...
  tft.println("NPK calibrations enabled");
  ...
  Serial.println("Sending data every 2s when connected.");
